...
import './AdminFashionCategoryForm.css'
...
function AdminFashionCategoryForm() {
      ...
      canvas.toBlob(
        (blob) => {
          ...
          resolve(
            new File(
              [blob],
              `fashion-category-${crypto.randomUUID()}.webp`,
              {
                type: 'image/webp',
              },
            ),
  ...
  async function uploadImage(
    ...
    const filePath =
      `categories/${crypto.randomUUID()}.webp`
    ...
    <main className="admin-category-form-page">
      <div className="admin-category-form-container">
        <div className="admin-category-page-card">
          ...
          <header className="admin-category-page-header">
            ...
            <p>
              Create and manage categories for
            ...
            <div className="admin-category-form-grid">
              ...
              <aside className="admin-category-preview-section">
                ...
                <div className="admin-category-preview-note">
                  ...
                  <p>
                    The saved image is always
                    exported as a 1200 × 1200
      ...
      {cropOpen && imagePreview && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Adjust fashion category image"
        >
...
export default AdminFashionCategoryForm